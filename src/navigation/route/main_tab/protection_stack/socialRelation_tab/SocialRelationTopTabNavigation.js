...
export default SocialRelationTopTabNavigation = () => {
	...
	return (
		<SocialRelationTab.Navigator
			...
			<SocialRelationTab.Screen name="MissingReportList" component={MissingReportList} />
			<SocialRelationTab.Screen name="ActivationList" component={ActivationList} />
