...
export default ShelterAssignEntrance = props => {
	...
	const goToPrivateShelter = () => {
		props.navigation.push('AssignShelterAddress', { shleter_type: 'private' });
	};
	const goToPublicShelter = () => {
		props.navigation.push('AssignShelterAddress', { shleter_type: 'public' });
	};
	...
	return (
		<View style={[login_style.wrp_main, { flex: 1 }]}>
			...
			<View style={[btn_style.btn_w522, shelterAssignEntrance_style.btn_w522_public]}>
				<AniButton btnTitle={'공립 보호소'} btnTheme={'shadow'} btnLayout={btn_w654} titleFontStyle={32} onPress={goToPrivateShelter} />
			</View>

			{/* (A)Btn_w522 */}
			<View style={[btn_style.btn_w522, shelterAssignEntrance_style.btn_w522_private]}>
				<AniButton btnTitle={'사립 보호소'} btnTheme={'shadow'} btnLayout={btn_w654} titleFontStyle={32} onPress={goToPublicShelter} />
			</View>
		</View>
	);
};
