...
export default AssignShelterAddress = props => {
	...
	React.useEffect(() => {
		...
		data.shelter_address.city != null && data.shelter_address.district != null && data.shelter_name != null ? setConfirmed(true) : setConfirmed(false)
	}, [data])
	...
	return (
		<View style={[login_style.wrp_main, { flex: 1 }]}>
			...
			<View style={[btn_style.btn_w654, assignShelterAddress_style.btn_w654]}>
				<AniButton btnTitle={'다음'} btnTheme={'shadow'} disable={!confirmed && true} btnLayout={btn_w654} titleFontStyle={32} onPress={goToNextStep} />
			</View>
		</View>
	);
};
