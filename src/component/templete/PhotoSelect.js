...
import { Text, View, TouchableWithoutFeedback, Image, ScrollView, FlatList, TouchableOpacity } from 'react-native';
...
export default PhotoSelect = (props) => {
	...
	const renderItem = React.useCallback((item, index) => {
		...
		return <LocalMedia isSingleSelection={false} onSelect={e => onSelect(e, index)} data={{ img_uri: item.node.image.uri }} index={selectedIndex[index]} />
	}, [selectedIndex])
