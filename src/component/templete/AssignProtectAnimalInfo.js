		...
		<View style={login_style.wrp_main}>
			...
			<View style={[temp_style.inputForm_assignProtectAnimal, assignProtectAnimal_style.selectedMediaList]}>
				...
				<View style={[temp_style.inputForm_assignProtectAnimal_line1]}>
					<Text style={[temp_style.text118_assignProtectAnimal]}>Text</Text>
					<View style={[temp_style.dropdownSelect_assignProtectAnimalInfo, assignProtectAnimal_style.dropdownSelect_year]}>
						<Text>(M)DropdownSelect</Text>
					</View>
					<Text style={[temp_style.text64_assignProtectAnimal, assignProtectAnimal_style.text118]}>Text</Text>
					<View style={[temp_style.dropdownSelect_assignProtectAnimalInfo, assignProtectAnimal_style.dropdownSelect_year]}>
						<Text>(M)DropdownSelect</Text>
					</View>
					<Text style={[temp_style.text64_assignProtectAnimal, assignProtectAnimal_style.text118]}>Text</Text>
