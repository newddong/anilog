...
export default UserPasswordCheck = props => {
	const moveToAssignUserHabitation = () => {
		props.navigation.push('AssignUserHabitation');
	};
	return (
		<View style={login_style.wrp_main}>
			...
			{/* (A)Btn_w654 */}
			<TouchableWithoutFeedback onPress={moveToAssignUserHabitation}>
				<View style={[btn_style.btn_w654, userPasswordCheck.btn_w654]}>
					<Text>(A)Btn_w654(비밀번호 확인 완료)</Text>
				</View>
