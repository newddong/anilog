...
export default AssignPetProfileImage = props => {
	...
	const selectPhoto = () => {
		console.log('Prosroute name ' + props.route.name);
	...
	return (
		<View style={[login_style.wrp_main, {flex: 1}]}>
			...
			<View style={[btn_style.btn_w654, assignPetProfileImage_style.btn_w654]}>
				...
				<AniButton btnTitle={'확인'} btnTheme={'shadow'} btnStyle={'filled'} btnLayout={btn_w654} titleFontStyle={24} onPress={goToNextStep} />
			</View>
		</View>
	);
};
