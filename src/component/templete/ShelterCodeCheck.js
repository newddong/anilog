	...
	return (
		<View style={[login_style.wrp_main, { flex: 1 }]}>
			...
			<View style={[btn_style.btn_w654, shelterCodeCheck_style.btn_w654]}>
				<AniButton btnTitle={'코드 확인'} btnTheme={'shadow'} disable={confirmed ? false : true} btnLayout={btn_w654} titleFontStyle={32} onPress={goToNextStep} />
			</View>
		</View>
	);
};
