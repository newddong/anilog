		...
		<ScrollView>
			<View style={[animalProtectDetail.container,]}>
				<View style={[animalProtectDetail.animalNeedHelp_container]}>
					<AnimalNeedHelp data={props.data.protect_request_pet_data} />
				</View>
				<View style={[animalProtectDetail.details_container]}>
					...
					<View style={[animalProtectDetail.detail]}>
						...
						<View style={[animalProtectDetail.detail_content]}>
							<Text style={[txt.noto24]}>{data.protect_act_address.city} {data.protect_act_address.district} {data.protect_act_address.neighbor} </Text>
						</View>
					</View>
					{/* 연락처 */}
					<View style={[animalProtectDetail.detail]}>
					...
					<View style={[animalProtectDetail.detail]}>
						...
						{data.protect_act_companion_history.map((v, i) => {
							return (
								<View style={[animalProtectDetail.detail_content]}>
									<Text style={[txt.noto24]}>{i + 1}.  {v.companion_pet_species} / 나이 : {v.companion_pet_age} / 반려생활 : {v.companion_pet_period}</Text>
					...
					<View style={[animalProtectDetail.detail]}>
						...
						<View style={[animalProtectDetail.detail_content]}>
							...
							<Text style={[txt.noto24, { color: data.protect_act_checklist.is_knowledge_sanitation ? APRI10 : GRAY10 }]}>- 반려동물 청결 지식 확인</Text>
						</View>
					</View>
					{/* 신청 동기  */}
					<View style={[animalProtectDetail.detail]}>
