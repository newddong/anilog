		...
		<View style={[controllableAccount.container,]}>
			...
			<View style={[controllableAccount.rightContainer]}>
				<View style={[controllableAccount.btn_w108_controllableAccount]}>
					{following ? (
						<AniButton btnTitle={'팔로우'} btnTheme={'noShadow'} btnStyle={'border'} titleFontStyle={24} btnLayout={btn_w108} />
					) : (
						<AniButton btnTitle={'팔로잉'} btnTheme={'gray'} btnStyle={'filled'} titleFontStyle={24} btnLayout={btn_w108} />
					)}
				</View>
				{checkBox ? (
					false
