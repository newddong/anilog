...
export default function HashText(props) {
	return <Text style={props.style}>{makeFeedInputView(props.children)}</Text>;
}

const makeFeedInputView = inpdut => {
	let arr0 = '해쉬나 계정에 대한 테그가 없는 글입니다. 테스트용이라 삭제하셔도 됩니다.';
	let input =
		'&@&@시프리티|&|61c5667e38c5f6dee5a8b77f&@&@ &@&@레몬이|&|61c5669d38c5f6dee5a8b782&@&@ &#&#띠롱|&|띠롱&#&#오늘은&@&@기영|&|eioasd&@&@이와함께 &#&#딸기|&|aslkdfja&#&# 를&@&@효쏭|&|aslfs&@&@과 함께 사먹었어요 &@&@행복&@&@이는&#&#간식을&#&#먹네요$$부럽네요$$증말';
	...
	const onUserClick = userID => {
		navigation.navigate('UserProfile',{userobject:{_id:userID}});
	};
