...
export default Input24 = props => {
	...
	return (
		<View style={{flexDirection: 'row'}}>
			<View style={{height: 122 * DP}}>
				{/* 모든 text에 fontPadding false 적용 잊지말것 */}
				<View style={{flexDirection: 'row'}}>
					<Text style={[txt.noto24, {color: APRI10, includeFontPadding: false, height: 40 * DP}]} ellipsizeMode={'tail'} numberOfLines={1}>
						{props.title}
					</Text>
					<Text style={[txt.noto28, {color: APRI10, includeFontPadding: false, color: 'red', marginLeft: 100 * DP, includeFontPadding: false}]}>
						*
					</Text>
				</View>
				...
				<View style={{height: 82 * DP, borderBottomWidth: 2 * DP, borderBottomColor: setBorderColor()}}>
					<TextInput
						ref={inputRef}
			...
			<View>
				...
				<View style={{height: 20 * DP, backgroundColor: 'red', width: 10}}></View>
			</View>
			<View style={{height: 122 * DP, backgroundColor: 'purple', width: 10}}></View>
		</View>
	);
};
